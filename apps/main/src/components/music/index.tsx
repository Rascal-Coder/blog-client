        ...
        <div className='player'>
          <div className='player__top'>
            ...
            <div className='player-controls'>
              ...
              <a target='_blank' href={import.meta.env.RICK_GITHUB} className='player-controls__item' rel='noreferrer'>
                <svg className='icon'>
          ...
          <div className='progress'>
            <div className='progress__top'>
              <div className='album-info'>
                <div className='album-info__name'>{tracks[currentTrackIndex].artist}</div>
                <div className='album-info__track'>{tracks[currentTrackIndex].name}</div>
              </div>
              {Boolean(duration) && <div className='progress__duration'>{duration}</div>}
            </div>
            <div className='progress__bar' onClick={clickProgress}>
              <div className='progress__current' style={{ width: barWidth }}></div>
            </div>
            {Boolean(currentTime) && <div className='progress__time'>{currentTime}</div>}
          </div>
        </div>
      </div>

      <svg xmlns='http://www.w3.org/2000/svg' className='hidden' xmlnsXlink='http://www.w3.org/1999/xlink'>
        <defs>
